...
if keyword_matches.empty:
    st.error("No HBI profiles were found for this research keyword from publications.")
...
st.markdown(
    f'<p style="font-size:1.15rem;">{len(profiles):,} HBI profile'
    f'{"s" if len(profiles) != 1 else ""} with this exact research keyword</p>',
    unsafe_allow_html=True,
)
st.caption(
    "Supporting-publication counts reflect the member’s publications associated "
    "with this keyword in the directory’s 2004–2026 publication dataset."
)
