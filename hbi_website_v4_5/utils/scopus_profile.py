...
def publication_panel_help_text(summary: pd.DataFrame) -> str:
    ...
    return (
        ...
        "researcher. The directory’s publication coverage spans 2004–2026."
    ...
    *,
    ...
    st.markdown(
        ...
        help=(
            ...
            f"to this researcher. They reflect the selected period ({year_from}–"
            f"{year_to}) and are ranked by supporting publication count and "
            "recency."
        ),
    )
    ...
    if not filtered_keywords.empty:
        ...
        st.info(
            "No indexed publications were found for this researcher in the "
            f"selected period ({year_from}–{year_to})."
        )
    else:
        st.info(
            "No research keywords were found in this researcher’s publications "
            f"in the selected period ({year_from}–{year_to})."
        )
